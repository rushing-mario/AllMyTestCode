 ...
 */
public class SameProcessActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting.edit().putString(ActivityProcessMain.SHARE_PREF_TEST1, "SameProcessActivity").commit();
        ...
        setting2.edit().putString(ActivityProcessMain.SHARE_PREF_TEST2, "SameProcessActivity").commit();
    }
}
