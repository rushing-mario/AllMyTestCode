package com.okry.amt.ui.popupwindow;
 ...
 */
public class PopupWindowMain extends BaseActivity implements Button.OnClickListener{
    ...
    private PointerPopupWindow create() {
        ...
        PointerPopupWindow p = new PointerPopupWindow(this, 400);
